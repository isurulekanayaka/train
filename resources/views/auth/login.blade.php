        ...
        <div class="flex justify-center items-center h-screen mx-auto ">
            ...
            <div id="loginForm"
                ...
                <div class="flex flex-col w-full bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <div class="flex justify-center mt-1">
                        <span>Don't have an account yet? <button id="registerBtn"
                                class="text-blue-500 rounded-lg transition duration-200 mb-6">Sign up
                                here</button></span>
                    </div>
            ...
            <div id="registerForm"
                ...
                <div class="flex flex-col w-full p-8 bg-white rounded-lg shadow-lg">
                    ...
                    <div class="flex justify-center mt-1">
                        <span>Already have an account? <button id="loginBtn"
                                class="text-blue-500 rounded-lg transition duration-200 mb-6">Log in
                                here</button></span>
                    </div>
