        ...
        <div class="flex justify-center items-center h-screen mx-auto">
            ...
            <div class="flex items-center justify-center gap-10 w-full max-w-2xl transition-transform transform duration-300 ease-in-out hover:shadow-xl fade-in"
                ...
                <div class="flex flex-col w-full bg-white p-8 rounded-lg shadow-lg">
                    <h2 class="text-3xl font-bold text-center text-gray-700">Froget Password Form</h2>
                    <form action="{{ route('froget_password') }}" method="POST" class="flex flex-col w-full mt-5">
                        @csrf
                        ...
                        <button
                            class="bg-blue-600 text-white rounded-lg p-3 hover:bg-blue-700 transition duration-200">Froget
                            Password</button>
                    </form>
