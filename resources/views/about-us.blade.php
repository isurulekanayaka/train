...
<div class="w-full py-10 bg-gray-50">
    <div class="max-w-6xl px-4 mx-auto space-y-10 sm:px-6 lg:px-8">
        ...
        <div class="grid items-center grid-cols-1 gap-10 md:grid-cols-2">
            <!-- Feedback Form (Left) -->
            <section id="feedback" class="max-w-2xl p-8 mx-auto bg-gray-100 rounded-lg shadow-lg">
                ...
                <form id="feedbackForm" method="post" class="space-y-6">
                    <div class="form-group">
                        ...
                        <textarea id="review_text" name="review_text" rows="4" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="reviewer_name" class="block text-sm font-medium text-gray-700">Your Name:</label>
                        <input type="text" id="reviewer_name" name="reviewer_name" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                    </div>
                    <div class="form-group">
            ...
            <div class="p-6">
                <h3 class="mb-2 text-lg font-medium text-gray-800">About Our Train Online System</h3>
        ...
        <div class="grid items-center grid-cols-1 gap-10 md:grid-cols-2">
            <!-- Contact Image (Left) -->
            <div class="p-6">
                <img src="{{ asset('img/train3.jpg') }}" alt="Contact Illustration" class="w-full h-auto rounded-lg shadow-md" />
            </div>

            <!-- Contact Form (Right) -->
            <section id="contact" class="w-full max-w-2xl p-8 mx-auto bg-gray-200 rounded-lg shadow-lg">
                <h2 class="mb-6 text-2xl font-semibold text-center text-gray-900">Emergency Contacts & Inquiries</h2>
                <h3 class="mb-4 text-lg font-medium text-center text-gray-800">Contact Us</h3>
                <form id="contactForm" method="post" class="space-y-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="first_name" name="first_name" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="form-group">
                        <label for="last_name" class="block mb-1 text-sm font-medium text-gray-700">Last Name:</label>
                        <input type="text" id="last_name" name="last_name" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="form-group">
                        <label for="email" class="block mb-1 text-sm font-medium text-gray-700">Email:</label>
                        <input type="email" id="email" name="email" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="form-group">
                        <label for="mobile" class="block mb-1 text-sm font-medium text-gray-700">Mobile Number:</label>
                        <input type="tel" id="mobile" name="mobile" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="form-group">
                        <label for="message" class="block mb-1 text-sm font-medium text-gray-700">Message:</label>
                        <textarea id="message" name="message" rows="4" class="w-full p-2 transition duration-300 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required></textarea>
                    </div>
