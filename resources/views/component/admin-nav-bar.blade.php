<nav class="w-full border mb-10">
    <div class="flex justify-between m-5 ">
        ...
        <div class="flex relative gap-10 justify-center h-fit items-center">
            ...
            <a href="" class="text-lg">Add Trains</a>

            <li class="dropdown">
                <a href="#" onclick="toggleDropdown('trainDropdown')"> Trains </a>
                <div id="trainDropdown" class="dropdown-content1">
                    <a href="#">Add Trains</a>
                    <a href="#">Manage Trains</a>
                    <a href="#">Delay Trains</a>
                    <a href="#">Cancel Trains</a>
                </div>
            </li>
            ...
            <div class="relative">
                ...
                <div id="profileDropdown" class="absolute right-0 mt-2 w-52 bg-white rounded-lg shadow-lg hidden z-10">
                    <div class="p-2 w-full">
                        <p class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-lg">Name</p>
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-lg">Profile</a>
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-lg">Logout</a>
                    </div>
                </div>
            </div>
        </div>
